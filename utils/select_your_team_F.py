...
def team_f(df,catb_F):
  ...
  def read(df,df_aux_1):
    score_F=[]
    positions=[]
    df_score=predict_model(catb_F,data=df_aux_1)
    ...
    for i in range(len(df_aux_2)):
      if df_aux_2.at[i,'POSITION_F']=='C':
        positions.append('C')
      elif df_aux_2.at[i,'POSITION_F']=='PF':
        positions.append('PF')
      elif df_aux_2.at[i,'POSITION_F']=='PG':
        positions.append('PG')
      elif df_aux_2.at[i,'POSITION_F']=='SF':
        positions.append('SF')
      elif df_aux_2.at[i,'POSITION_F']=='SG':
        positions.append('SG')


    df_aux_2=df_aux_2.drop(['POSITION_F'],axis=1)
